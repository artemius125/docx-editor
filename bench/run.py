...
CORPORA = {
    ...
    # Третий корпус, собранный специально как незнакомый: тема далека от двух
    # приёмочных, дефекты заложены по классам. Маркеров оценщика под него нет —
    # его вердикты в метрику Э не идут, он для проверки на новых данных.
    "battery": {
        "doc": "/home/artem/Загрузки/Аккумуляторы.docx",
        "edits": "/home/artem/Загрузки/Правки_Аккумуляторы_20.md",
    },
}
